...
tell application "Contacts"
	...
	repeat with thisPerson in peopleToChange
		...
		-- 	set the birth date of thisPerson to missing value
		-- END -- 1) Delete birthday for each person
		
		-- START -- 1) Delete address for each person
		delete address of thisPerson
		-- END -- 1) Delete address for each person
		
		-- START -- 1) Delete url for each person
		delete url of thisPerson
		-- END -- 1) Delete url for each person
		-- START -- 1) Delete note for each person
		--	set note of person i to ""
		-- END -- 1) Delete note for each person
