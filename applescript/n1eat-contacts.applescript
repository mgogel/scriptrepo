...
tell application "Contacts"
	...
	repeat with thisPerson in peopleToChange
		...
		-- 	delete skypeid of thisPerson
		--		delete FacebookID of thisPerson
		
		delete AIM Handle of thisPerson
		--delete IM of thisPerson
		
		
		--	delete username ID of thisPerson
		...
		set SocialProfileList to {"Twitter", "Linkedin", "other", "Facebook"}
		...
		if SocialProfileList ­ {} then
			...
			delete (every url of thisPerson whose value contains "/")
			delete (every url of thisPerson whose value contains "w")
			delete every url of thisPerson
